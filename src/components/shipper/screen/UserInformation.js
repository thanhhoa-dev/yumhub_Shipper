      ...
      <ScrollView>
        <View style={styles.ContainerHeader}>
          ...
          <View style={styles.ViewAccuracy}>
            <Text style={styles.TextContentAccuracy}>
              Xác thực email và giúp tài khoản bảo mật hơn
            </Text>
          ...
          <View style={styles.ContainerFunction}>
            ...
            <View style={styles.ContainerFunction}>
              ...
              <View style={styles.ItemFunction}>
                ...
                <TouchableOpacity
                  style={styles.ButtonNameFunction}
          ...
          <TouchableOpacity
            ...
            <View style={styles.BackgroundContainerModal}>
              <View style={styles.ContainerModal}>
                <Text style={styles.TextPaymentMethods}>
                  Phương thức thanh toán
                </Text>
                <View style={styles.ViewContentPaymentMethods}>
                  <Text style={styles.TextNoCash}>
                    Thanh toán không dùng tiền mặt
                  </Text>
                  <Text style={styles.TextInstruct}>
                    Đặt mặc định bằng cách trượt sang trái
                  </Text>
                </View>
                  ...
                  <View style={styles.ViewContainerCreditModal}>
                    ...
                    <View style={styles.ViewContainerCredit}>
                      <View style={styles.ViewContentCredit}>
                        ...
                        <Text style={styles.TextTypesCredit}>
                          Visa, Mastercard và JCB
                        </Text>
                      </View>
                      <View>
