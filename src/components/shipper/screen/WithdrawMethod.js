...
const TopUpPaymentMethod = () => {
    ...
    return (
        <StripeProvider
            publishableKey="pk_test_51PaYulRsnazNxSTCktHuuoNWsy68FTRjdLVA2JSUgjpUzM9alpEeRbMC04ZWunikpstGMwPcQKIVDVQGsS5WR6LK0041Ws5py9"
                ...
                <View style={styles.container}>
                    ...
                    <View style={confirm ? { display: 'none' } : null}>
                        ...
                        <View style={styles.rowPaymentMethod}>
                            ...
                            <Text style={styles.txtMoney}>Tài khoản liên kết</Text>
                        </View>
                        <View style={styles.containerPaymentMethod}>
                            ...
                            <TouchableOpacity
                                ...
                                <Image source={require('../../../assets/wallet.png')} style={styles.icItemPayment} />
