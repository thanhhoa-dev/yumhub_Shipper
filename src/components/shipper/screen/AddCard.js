    ...
    <View style={styles.ContainerAddCard}>
      <View style={styles.ViewContainerAddCard}>
        ...
        <View style={styles.ViewContainerSecurity}>
          <View style={styles.ViewSecurity}>
            <MaterialIcons name={'security'} size={16} color={'white'} />
          </View>
          <Text style={styles.TextSecurityPayment} numberOfLines={3}>
            {' '}
            Secure Payment
          </Text>
          <MaterialIcons
      ...
      <View style={styles.ViewContainerMain}>
        <View style={styles.ViewContainerNumberCard}>
          ...
          <TextInput
            style={styles.TextInputInformation}
        ...
        <View style={styles.ViewContentDeduction}>
          <Image
            ...
            source={require('../../../assets/atm-card.png')}
          />
          <Text style={styles.TextContent}>
            1.000đ sẽ được trừ để xác minh thông tin thẻ.{'\n'}Đừng lo lắng,
            chúng tôi sẽ hoàn trả lại bạn ngay sau khi hoàn tất
          </Text>
        </View>
      </View>
      <View style={styles.ViewContainerButtonSave}>
        <View style={styles.ViewContentSave}>
          ...
          <Text style={styles.TextSave}>
            ...
            <Text style={styles.TextCondition}>Điều khoản & Điều kiện</Text>
          </Text>
        </View>
